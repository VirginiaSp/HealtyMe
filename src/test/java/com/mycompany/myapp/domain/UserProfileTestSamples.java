...
public class UserProfileTestSamples {
    ...
    public static UserProfile getUserProfileSample1() {
        return new UserProfile().id(1L).firstName("firstName1").lastName("lastName1").phone("phone1");
    }

    public static UserProfile getUserProfileSample2() {
        return new UserProfile().id(2L).firstName("firstName2").lastName("lastName2").phone("phone2");
    }
