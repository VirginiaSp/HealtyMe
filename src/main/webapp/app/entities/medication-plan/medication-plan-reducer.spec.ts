...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICATIONPLAN_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICATIONPLAN actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICATIONPLAN actions', async () => {
      const arg = { id: 2410 };
    ...
    it('dispatches UPDATE_MEDICATIONPLAN actions', async () => {
      const arg = { id: 2410 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICATIONPLAN actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICATIONPLAN actions', async () => {
      const arg = 42666;
