...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICATION actions', async () => {
      const arg = { id: 30457 };
    ...
    it('dispatches UPDATE_MEDICATION actions', async () => {
      const arg = { id: 30457 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICATION actions', async () => {
      const arg = 42666;
