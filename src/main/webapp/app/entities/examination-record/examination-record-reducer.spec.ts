...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMINATIONRECORD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXAMINATIONRECORD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXAMINATIONRECORD actions', async () => {
      const arg = { id: 30694 };
    ...
    it('dispatches UPDATE_EXAMINATIONRECORD actions', async () => {
      const arg = { id: 30694 };
    ...
    it('dispatches PARTIAL_UPDATE_EXAMINATIONRECORD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXAMINATIONRECORD actions', async () => {
      const arg = 42666;
