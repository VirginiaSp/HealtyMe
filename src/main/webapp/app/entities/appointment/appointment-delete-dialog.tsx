...
export const AppointmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="healthyMeApp.appointment.delete.question">
        <Translate contentKey="healthyMeApp.appointment.delete.question" interpolate={{ id: appointmentEntity.id }}>
