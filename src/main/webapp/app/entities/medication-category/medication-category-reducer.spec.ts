...
import reducer, {
  ...
  reset,
  updateEntity,
} from './medication-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICATIONCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICATIONCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICATIONCATEGORY actions', async () => {
      const arg = { id: 25519 };
    ...
    it('dispatches UPDATE_MEDICATIONCATEGORY actions', async () => {
      const arg = { id: 25519 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICATIONCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICATIONCATEGORY actions', async () => {
      const arg = 42666;
