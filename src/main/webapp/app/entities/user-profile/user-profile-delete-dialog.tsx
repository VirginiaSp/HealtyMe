...
export const UserProfileDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="healthyMeApp.userProfile.delete.question">
        <Translate contentKey="healthyMeApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
