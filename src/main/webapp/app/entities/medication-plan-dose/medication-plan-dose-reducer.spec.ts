...
import reducer, {
  ...
  reset,
  updateEntity,
} from './medication-plan-dose.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEDICATIONPLANDOSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MEDICATIONPLANDOSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MEDICATIONPLANDOSE actions', async () => {
      const arg = { id: 30547 };
    ...
    it('dispatches UPDATE_MEDICATIONPLANDOSE actions', async () => {
      const arg = { id: 30547 };
    ...
    it('dispatches PARTIAL_UPDATE_MEDICATIONPLANDOSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MEDICATIONPLANDOSE actions', async () => {
      const arg = 42666;
