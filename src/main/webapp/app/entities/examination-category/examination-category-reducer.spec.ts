...
import reducer, {
  ...
  reset,
  updateEntity,
} from './examination-category.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXAMINATIONCATEGORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXAMINATIONCATEGORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXAMINATIONCATEGORY actions', async () => {
      const arg = { id: 788 };
    ...
    it('dispatches UPDATE_EXAMINATIONCATEGORY actions', async () => {
      const arg = { id: 788 };
    ...
    it('dispatches PARTIAL_UPDATE_EXAMINATIONCATEGORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXAMINATIONCATEGORY actions', async () => {
      const arg = 42666;
